...
SPECTACULAR_SETTINGS = {
    'TITLE': 'QA Recipe Converter API',
    'DESCRIPTION': 'API de conversion de documents Word de recettes QA en fichiers Excel structurés, scripts Gherkin et projets Cypress.',
    'VERSION': '2.2.0',
